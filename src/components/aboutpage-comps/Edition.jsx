    ...
    return (
        <section name="Edition" className='relative text-white p-4 py-10 grid gap-10 sm:grid-cols-2 max-w-[1000px] mx-auto mb-8'>
            ...
            <section className='grid gap-10'>
                <div>
                    <h3 className='text-sm text-gray-400'>Blogs</h3>
                    <h2 className='text-3xl font-semibold mt-2'>Some Blogs That I Have Written.</h2>
                </div>
            ...
            {/* <article className='bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden'> */}
                ...
                <div className='grid place-items-center'>
                    <a href="https://medium.com/@mneeraj2133" target='_blank' className='text-black font-semibold text-[16px] w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-t from-green-400 to-primary-color cursor-pointer mx-auto md:mx-0 self-end max-w-max'>
