      ...
      <section name="Home" className='relative w-full h-screen'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4'>I'm Neeraj Meena</h1>
            ...
            <p className='text-gray-300 py-4 max-x-md text-justify'>I am currently pursuing my Master's in Computer Applications from NIT Bhopal, I am an enthusiastic advocate of open-source development. I actively contribute to various open-source projects, leveraging the power of collaboration and sharing knowledge with the global developer community.  Moreover, I am highly motivated to explore remote work opportunities.</p>
          ...
          <div className='flex order-1 md:order-2 mt-8 md:mt-0'>
              <img src="/images/neeraj-green.jpg" alt="My profile" className='mb-2 rounded-2xl mx-auto w-2/3 max-w-lg md:max-w-sm object-cover md:w-[70rem] shadow-2xl shadow-primary-color/20' style={{ filter: 'drop-shadow(0px -4px 4px rgba(0, 255, 0, 0.5))' }} />
